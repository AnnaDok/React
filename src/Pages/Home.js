                        ...
                        <div className="col">
                            <Card className="m-4 text-center" bg="light" border="primary">
                                ...
                                <Card.Body>
                                    ...
                                    <Button href="/team1" variant="primary">About team</Button>
                                </Card.Body>
                            </Card>
                        </div>
                        <div className="col">
                            <Card className="m-4 text-center" bg="light" border="primary">
                                ...
                                <Card.Body>
                                    ...
                                    <Button href="/team2" variant="primary">About team</Button>
                                </Card.Body>
                            </Card>
                        </div>
                        ...
                        <div className="col">
                            <Card className="m-4 text-center" bg="light" border="primary">
                                ...
                                <Card.Body>
                                    ...
                                    <Button href="/team3" variant="primary">About team</Button>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
