...
import Dev from '../Pages/Team1';
import Nature from '../Pages/Team2';
import Market from '../Pages/Team3';
        ...
        <>
                ...
                <Container>
                    <Navbar.Brand href="/">
                        <img
                            ...
                            height="30"
                            width="30"
                            className="d-inline-block aligb-top"
                            alt="Logo"/> React Site
                    </Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Form className='d-flex' style={{position: 'absolute', right: '0', marginRight: '10%'}}>
                            <FormControl
                                type="text"
                                placeholder="Search"
                                className="mr-sm-2"
            ...
            <Router>
                <Routes>
                    ...
                    <Route path="/team1" element={<Dev />}/>
                    <Route path="/team2" element={<Nature />}/>
                    <Route path="/team3" element={<Market />}/>
